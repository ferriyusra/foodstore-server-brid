...
async function store(req, res, next) {
    ...
    try {
        ...
        // Dapatkan `items` di keranjang belanja 
        ...
        // clear cart items
        await CarItem.deleteMany({ user: req.user._id })
...
async function index(req, res, next) {
    ...
    try {
        ...
        // dapatkan limit dan skip dari query string
        ...
        // respon ke client dengan mengembalikan data dari count
        return res.json({
